...
//    private ProgressBar progressBar;
    ...
    public static PictureViewerFragment newInstance(String imageUrl) {
        final PictureViewerFragment f = new PictureViewerFragment();
...
//        GlideUtils.loadImage(getContext(),3,mImageUrl,mImageView);
