...
public class GoodsDetailXuzhiAdapter extends BaseRecyclerAdapter<String> {
    ...
    public GoodsDetailXuzhiAdapter(Context context, List<String> datas) {
        super(context, datas);
    }
    ...
    protected void showViewHolder(BaseRecyclerViewHolder holder, final int position) {
        ...
        viewHolder.detailContent.setText(mDatas.get(position));
        String title = "";
        if (position == 0) {
            title = "产品咨询";
        } else if (position == 1) {
...
//        webview.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);
    ...
    protected BaseRecyclerViewHolder createViewHOldeHolder(ViewGroup parent, int viewType) {
        ...
        mView = mInflater.inflate(R.layout.item_zuzhi, parent, false);
