...
import com.BlackDiamond2010.hzs.R.id;
...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    private void initView() {
        mMoreScale = (TextView) findViewById(id.moreScale);
        mSwitchSize = (TextView) findViewById(id.switchSize);
        mChangeRotate = (TextView) findViewById(id.change_rotate);
        fangda  = (ImageView) findViewById(id.fullscreen);
//        fangda.setVisibility(View.GONE);

        mMoreScale.setVisibility(View.GONE);
        mSwitchSize.setVisibility(View.GONE);
