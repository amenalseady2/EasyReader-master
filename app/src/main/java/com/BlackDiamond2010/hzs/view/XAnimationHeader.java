...
public class XAnimationHeader extends LinearLayout{
    //刷新头布局
    ...
    public XAnimationHeader(Context context) {
        super(context);
        initView(context);
    }

    public XAnimationHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        mContentView = (LinearLayout) View.inflate(context, R.layout.head_recycleview_animation, null);
        //宽高
        ...
        mImageView = (ImageView) findViewById(R.id.loding_animation_img);
        //查找头布局控件
        //刷新状态字体
...
//        }
        ...
        switch (status) {
            ...
            case STATE_REFRESHING:
                mImageView.setImageResource(R.drawable.loding_animlist);
    ...
    public void onMove(float delta) {
        if (getVisibleHeight() > 0 || delta > 0) {
            ...
            int height = getVisibleHeight();
            if(height <= CommonUtils.Dp2Px(getContext(), 28f)){
                mImageView.setImageResource(R.drawable.loding_anim1);
            }else if(height > CommonUtils.Dp2Px(getContext(), 28f) && height <= CommonUtils.Dp2Px(getContext(), 43f)){
                mImageView.setImageResource(R.drawable.loding_anim2);
            }else if(height > CommonUtils.Dp2Px(getContext(), 43f) && height <= CommonUtils.Dp2Px(getContext(), 58f)){
                mImageView.setImageResource(R.drawable.loding_anim3);
            }else if(height > CommonUtils.Dp2Px(getContext(), 58f) && height <= CommonUtils.Dp2Px(getContext(), 73f)){
                mImageView.setImageResource(R.drawable.loding_anim4);
            }else{
                mImageView.setImageResource(R.drawable.loding_anim5);
            }
