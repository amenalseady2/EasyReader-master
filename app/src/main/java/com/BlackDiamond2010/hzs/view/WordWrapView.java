...
public class WordWrapView extends ViewGroup {
    private static final int PADDING_HOR = 0;//水平方向padding     textview 的水平pading
    private static final int PADDING_VERTICAL = 10;//垂直方向padding
    private static final int SIDE_MARGIN = 0;//左右外间距   距离lift的 距离
    private static final int TEXT_MARGIN = 40;  //两个textview  的 距离
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int index = 0; index < childCount; index++) {
            ...
            child.setPadding(PADDING_HOR, PADDING_VERTICAL, PADDING_HOR, PADDING_VERTICAL + 10);
